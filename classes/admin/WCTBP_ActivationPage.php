...
class WCTBP_ActivationPage
{
	...
	public function add_page($cap = "manage_woocommerce" )
	{
		...
		$this->page = add_submenu_page( null,
										esc_html__($this->plugin_name.' Activator', 'woocommerce-time-based-pricing'), 
										esc_html__($this->plugin_name.' Activator', 'woocommerce-time-based-pricing'), 
										  $cap, 
										  $this->page_slug, 
	...
	function footer_scripts(){
		//to work: script_tag postboxes.add_postbox_toggles(pagenow); script_tag 
		?>
	...
	public function render_page()
	{
		...
		wp_register_script('vanquish-activator', $this->plugin_path.'/js/vendor/vanquish/activator.js', array('jquery'));
		 $js_settings = array(
				'purchase_code_invalid' => esc_html__( 'Purchase code is invalid!', 'woocommerce-time-based-pricing' ),
				'buyer_invalid' => esc_html__( 'Buyer name is invalid!', 'woocommerce-time-based-pricing' ),
				'item_id_invalid' => esc_html__( 'Item id is invalid!', 'woocommerce-time-based-pricing' ),
				'num_domain_reached' => esc_html__( 'Max number of domains reached! You have to purchase a new license. The current license has been activated in the following domains: ', 'woocommerce-time-based-pricing' ),
				'status_default_message' => esc_html__( 'Verifing, please wait...', 'woocommerce-time-based-pricing' ),
				'db_error' => esc_html__( 'There was an error while verifing the code. Please retry in few minutes!', 'woocommerce-time-based-pricing' ),
				'purchase_code_valid' => esc_html__( 'Activation successfully completed!', 'woocommerce-time-based-pricing' ),
				'empty_fields_error' => esc_html__( 'Buyer and Purchase code fields must be filled!', 'woocommerce-time-based-pricing' ),
	...
	function add_meta_boxes()
	{
		 ...
		 add_meta_box( 'vanquish_activation', 
					esc_html__('Activation','woocommerce-time-based-pricing'), 
